...
def calculate_gradient_penalty(batch_size, device, disc, real_images, fake_images, lambda_term):
...
'''
# borrowed from https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix/blob/master/models/networks.py
import torch
import torch.nn as nn
